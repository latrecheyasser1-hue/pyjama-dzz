    ...
    try {
      ...
      const mappedProducts: Product[] = prodData.map((p: any) => {
        ...
        return {
          ...
          sellingPrice: p.selling_price !== null && p.selling_price !== undefined ? Number(p.selling_price) : (descMeta.warehouses?.DELIVERY?.sellingPrice ?? 0),
          storePrice: descMeta.warehouses?.STORE?.storePrice ?? descMeta.warehouses?.STORE?.sellingPrice ?? descMeta.storePrice ?? (p.store_price !== null && p.store_price !== undefined ? Number(p.store_price) : p.selling_price),
          storeOldPrice: descMeta.warehouses?.STORE?.storeOldPrice ?? descMeta.warehouses?.STORE?.oldPrice ?? undefined,
          storeBulkPrice: descMeta.warehouses?.STORE?.storeBulkPrice ?? descMeta.warehouses?.STORE?.bulkPrice ?? undefined,
          oldPrice: descMeta.warehouses?.DELIVERY?.oldPrice ?? (p.old_price ? Number(p.old_price) : undefined),
          bulkPrice: descMeta.warehouses?.DELIVERY?.bulkPrice ?? (p.bulk_price !== null && p.bulk_price !== undefined ? Number(p.bulk_price) : (p.bulk_discount_price_5 !== null && p.bulk_discount_price_5 !== undefined ? Number(p.bulk_discount_price_5) : (descMeta.bulkPrice ?? undefined))),
          bulk_price: descMeta.warehouses?.DELIVERY?.bulkPrice ?? (p.bulk_price !== null && p.bulk_price !== undefined ? Number(p.bulk_price) : (p.bulk_discount_price_5 !== null && p.bulk_discount_price_5 !== undefined ? Number(p.bulk_discount_price_5) : (descMeta.bulkPrice ?? undefined))),
          bulkDiscountPrice5: descMeta.warehouses?.DELIVERY?.bulkPrice ?? (p.bulk_price !== null && p.bulk_price !== undefined ? Number(p.bulk_price) : (p.bulk_discount_price_5 !== null && p.bulk_discount_price_5 !== undefined ? Number(p.bulk_discount_price_5) : (descMeta.bulkPrice ?? undefined))),
